---
name: shipping-with-git
description: "Automates the ship workflow with branch creation, push, and PR fully automated. Stage and commit require user confirmation. Blocks on default branch. Trigger only when user explicitly says \"shipping with git\" or \"/shipping-with-git\"."
...
5. **Generate PR description**
   - Run `/writing-pr-descriptions` to draft the PR body.
