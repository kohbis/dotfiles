---
name: running-copilot-cli
description: Runs coding, review, and GitHub operations using GitHub Copilot CLI in programmatic mode. Trigger only when user explicitly says "running copilot cli" or "/running-copilot-cli".
...
- For pure coding tasks without GitHub operations → consider `coding-with-codex`
- For pure code review without write needs → consider `reviewing-with-codex`
