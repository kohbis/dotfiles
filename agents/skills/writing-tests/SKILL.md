---
name: writing-tests
description: Adds effective tests focused on behavior verification, prioritization by risk, and validation through real test runs. Trigger when user says "writing tests", "/writing-tests", "write tests", "add tests", "unit tests", "test this", or requests testing for specific code, modules, or features.
---
