...
description: "Setup AI Context Management System for sharing project guidelines across Claude Code, GitHub Copilot, and Cursor. Trigger only when user explicitly says \"setup ai context\" or \"/setup-ai-context\"."
