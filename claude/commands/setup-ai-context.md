...
├── AGENTS.md                        # Auto-generated (with warning comment)
├── .github/
...
```json
{
  ...
  "tools": {
    ...
    "agents": {
      ...
      "overrideFile": "",
      "header": "# AGENTS.md - Project Guidelines for Custom Agents\n\nThis document provides guidelines for custom agents working on this project.\n",
      "footer": "\n---\n\n**Follow these guidelines to support consistent, high-quality development.**\n",
      "autoGeneratedNotice": "<!-- This file is auto-generated from .ai-context/ -->\n<!-- To make changes, edit .ai-context/base.md and run npm run ai-context:sync -->\n\n"
    }
  },
  "sync": {
...
Verify that four files are successfully generated:
